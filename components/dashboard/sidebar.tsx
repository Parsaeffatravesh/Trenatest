            ...
            <Link
              ...
              className={cn(
                ...
                isActive
                  ...
                  : "text-neutral-600 dark:text-neutral-300 hover:bg-neutral-100/80 dark:hover:bg-white/5 hover:text-sky-500 dark:hover:text-sky-400"
              )}
            >
              ...
              {!isCollapsed && isActive && (
                <div className="absolute inset-0 bg-sky-50 dark:bg-sky-500/10 opacity-100 transition-opacity rounded-2xl" />
              )}
            </Link>
          );
        })}
