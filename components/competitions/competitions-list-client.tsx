...
export default function CompetitionsListClient({ initialData }: Props) {
  ...
  const filteredCompetitions = React.useMemo(() => {
    let filtered = initialData.filter((competition) => {
    ...
    return filtered;
  }, [initialData, feeFilter, prizeFilter, sortOption, statusFilter, typeFilter]);
