...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="relative flex h-screen overflow-hidden bg-[#edf2f7] dark:bg-[#020617]" dir="rtl">
      ...
      <Sidebar />
      <main className="relative z-10 flex-1 overflow-y-auto scroll-smooth p-4 md:p-6 lg:p-8 space-y-4">
